  ...
  return (
    <a href={repo.html_url} target="_blank" rel="noreferrer"
      ...
      <div className="flex items-start justify-between">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={darkMode ? '#4a4560' : '#9ca3af'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
